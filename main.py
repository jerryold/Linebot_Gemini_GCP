...
async def send_user_message():
    ...
    result=await generate_gemini_text_complete('please say some morning motivation word for work, and find out most popular article on PTT or Dcard platform every day also attach each article link,please reply in zh-TW:')
...
async def send_afterwork_message():
    ...
    result=await generate_gemini_text_complete('please say some interesting word after work, and recommend type of dinner after work,please reply in zh-TW:')
    message = TextSendMessage(text=result.text)
    #create user_id list
    user_id_list = ['Uf7bc16da786923d10a1a8f6110a8b947','U0a954d9a98db73941f98259b1f4bfb83',
                    'Ue821ac226937a52b9f1770c20bc7cc35','U6545179fe8bf5e9cf2cf260203447770', #friends
