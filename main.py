...
async def send_user_message():
    ...
    result=generate_gemini_text_complete('please say some morning motivation word for work, and find out most popular article on PTT or Dcard platform every day, please reply in zh-TW:')
